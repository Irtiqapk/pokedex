...
fun PokemonDetail(pokemonDetailResponseModel: DetailResponseModel) {
    Column(
        ...
        Column(
            ...
            Image(
                painter = rememberImagePainter(data = pokemonDetailResponseModel.sprites.back_default),
                contentDescription = pokemonDetailResponseModel.name,
                modifier = Modifier
                    .size(80.dp)
        ...
        Column(
            ...
            if (pokemonDetailResponseModel.types.isNotEmpty()) {
                for (type in pokemonDetailResponseModel.types) {
                    Text(text = type.type.name.capitalize())
                }
            }
        }
        Column(
